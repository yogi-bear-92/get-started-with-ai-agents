...
$azureAiAgentPersonality = azd env get-value AZURE_AI_AGENT_PERSONALITY 2>$null
...
Add-Content -Path $envFilePath -Value "AZURE_AI_AGENT_PERSONALITY=$azureAiAgentPersonality"
Add-Content -Path $envFilePath -Value "AZURE_TENANT_ID=$azureTenantId"
