    ...
    def _parse_pdf(file_path: str) -> Tuple[str, Dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                logger.error("PyPDF2 library not installed. Please install it to parse PDF files.")
    ...
    def _parse_docx(file_path: str) -> Tuple[str, Dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                logger.error("python-docx library not installed. Please install it to parse DOCX files.")
            ...
            try:
                metadata["title"] = doc.core_properties.title or metadata.get("title", "")
